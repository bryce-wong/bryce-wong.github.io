...
* Lead the development of Spotfire visualization dashboards and improve agile project management along with troubleshooting/bug-tracking workflows
* Ingest, explore, and package data for insights into the impact of COVID-19 on marketing trends
...
*	Member of the Miami Project team, comprised of data science and analysis volunteers in collaboration with the Code for Miami organization to implement AI in Cities 
*	Engaged in exploratory data analysis, built/tested machine learning models, and stood up an API for the project partner to gain insight from. 
