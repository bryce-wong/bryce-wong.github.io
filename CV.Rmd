...
*	Perform ad hoc analyses with SQL and BI tools using a diverse range of data sets, including EDI dental claims data, card transaction data, Segment data from web and mobile apps, and bi-temporal ledger data. 
*	Partner with engineering to use data in driving new product features, to collect system requirements from a data modeling perspective, and to design user stories that inform test cases.
*	Develop, test and maintain custom ETLs and dbt models for analytical use cases, including using Python scripts and Jinja macros in transforming and documenting data. Deep experience with data wrangling nested JSON blobs outputted from protobuf messages into BigQuery data structs. 
*	Drive collaboration with sales, finance, and operations teams to define and implement measuring of company health and KPIs.
